            ...
            <div class="container">
                ...
                <div class="features-icon-wrapper row gx-0 gy-6 g-sm-12">
                    <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                        ...
                        <p class="features-icon-description">Code structure that all developers will easily understand
                            and fall in love with.</p>
                    </div>
                    <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                        <div class="mb-4 text-primary text-center">
                        ...
                        <p class="features-icon-description">Free updates for the next 12 months, including new demos
                            and features.</p>
                    </div>
                    <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card h-100">
                                            <div
                                                ...
                                                <p>“Vuexy is hands down the most useful front end Bootstrap theme I've
                                                    ever used. I can't wait to use it again for my next project.”</p>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card h-100">
                                            <div
                                                ...
                                                <p>“I've never used a theme as versatile and flexible as Vuexy. It's my
                                                    go to for building dashboard sites on almost any project.”</p>
                                                <div class="text-warning mb-4">
                                                    <i class="icon-base bx bxs-star"></i>
                                                    <i class="icon-base bx bxs-star"></i>
                                                    <i class="icon-base bx bxs-star"></i>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="small text-body-secondary mb-0">Founder of Hubspot
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card h-100">
                                            <div
                                                ...
                                                <p>This template is really clean & well documented. The docs are really
                                                    easy to understand and it's always easy to find a screenshot from
                                                    their website.</p>
                                                <div class="text-warning mb-4">
                                                    <i class="icon-base bx bxs-star"></i>
                                                    <i class="icon-base bx bxs-star"></i>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="small text-body-secondary mb-0">Design Lead at
                                                            Dribbble</p>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card h-100">
                                            <div
                                                ...
                                                <p>All the requirements for developers have been taken into
                                                    consideration, so I’m able to build any interface I want.</p>
                                                <div class="text-warning mb-4">
                                                    <i class="icon-base bx bxs-star"></i>
                                                    <i class="icon-base bx bxs-star"></i>
                                                    <i class="icon-base bx bxs-star"></i>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="small text-body-secondary mb-0">Founder of
                                                            Continental
                                                        </p>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card h-100">
                                            <div
                                                ...
                                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Veniam nemo
                                                    mollitia, ad eum officia numquam nostrum repellendus consequuntur!
                                                </p>
                                                <div class="text-warning mb-4">
                                                    <i class="icon-base bx bxs-star"></i>
                                                    <i class="icon-base bx bxs-star"></i>
                        ...
                        <div class="accordion" id="accordionExample">
                            <div class="card accordion-item">
                                <h2 class="accordion-header" id="headingOne">
                                    <button type="button" class="accordion-button" data-bs-toggle="collapse"
                                        ...
                                        aria-controls="accordionOne">Do you charge for each upgrade?</button>
                                </h2>

                                <div id="accordionOne" class="accordion-collapse collapse"
                                    data-bs-parent="#accordionExample">
                                    <div class="accordion-body">Lemon drops chocolate cake gummies carrot cake chupa
                                        chups muffin topping. Sesame snaps icing marzipan gummi bears macaroon dragée
                                        danish caramels powder. Bear claw dragée pastry topping soufflé. Wafer gummi
                            ...
                            <div class="card accordion-item active">
                                <h2 class="accordion-header" id="headingThree">
                                    <button type="button" class="accordion-button" data-bs-toggle="collapse"
                                        ...
                                        aria-controls="accordionThree">What is regular license?</button>
                                </h2>
                                <div id="accordionThree" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        or service(access is free and there will be no monthly subscription fee). Single
                                        regular license can be used for single end product and end product can be used
                                        by you or your client. If you want to sell end product to multiple clients then
                                        you will need to purchase separate license for each client. The same rule
                                        applies if you want to use the same end product on multiple domains(unique
                                        setup).
                            ...
                            <div class="card accordion-item">
                                ...
                                <div id="accordionFive" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">Lorem ipsum dolor sit amet consectetur, adipisicing
                                        elit. Sequi molestias exercitationem ab cum nemo facere voluptates veritatis
                                        quia, eveniet veniam at et repudiandae mollitia ipsam quasi labore enim
                                        architecto non!</div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-md-6 col-lg-12 col-xl-6">
                                        <div class="d-flex align-items-center">
                                            <div class="badge bg-label-primary rounded p-1_5 me-3"><i
                                                    class="icon-base bx bx-envelope icon-lg"></i></div>
                                            <div>
            ...
            <div class="container">
                <div class="row gx-0 gy-6 g-lg-10">
                    <div class="col-lg-5">
                        ...
                        <p class="footer-text footer-logo-description mb-6">Most developer friendly & highly
                            customisable Admin Dashboard Template.</p>
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="mb-4">
                                <a href="#" target="_blank" class="footer-link">Horizontal
                                    Layout</a>
                            </li>
                            <li class="mb-4">
                            ...
                            <li class="mb-4">
                                <a href="#" target="_blank" class="footer-link">Semi
                                    Dark Layout</a>
                            </li>
                            <li>
                                <a href="#" target="_blank" class="footer-link">Dark
                                    Layout</a>
                            </li>
                        </ul>
                    </div>
