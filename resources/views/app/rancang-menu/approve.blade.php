...
@section('content')
    ...
    <form action="/app/rancang-menu/approve" method="post" id="formApprove">
        @csrf

        <div id="daftarRancangan">
            <div class="card">
...
@section('script')
    <script>
        ...
        $(document).on('change', '#periode, #tanggal', function() {
            ...
            $.get(`/app/rancang-menu/approve-list?${params}`, function(data) {
                var daftarRancangan = $('#daftarRancangan');
                daftarRancangan.empty();

                daftarRancangan.html(data.view);
            })
        });
