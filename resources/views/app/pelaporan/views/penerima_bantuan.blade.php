...
@section('content')
    ...
    <div class="ratakanankiri">
        ...
        sesuai dengan kriteria penerima bantuan sebagaimana terlampir.
    </div>
    <div class="ratakanankiri">
        Demikian surat usulan ini kami sampaikan, atas perhatian Bapak/Ibu kami sampaikan terima kasih.
    </div>
    <br>
